...
async def check_name_duplicate(
    ...
    """Проверяет уникальность полученного названия проекта."""
...
async def check_charity_project_exists(
    ...
    """Проверяет, существует ли проект по id."""
...
async def check_before_update(
    ...
    """Проверяет, можно ли изменять переданный проект."""
...
async def check_full_amount_before_update(
    ...
    """Проверяет, можно ли изменять стоимость переданного проекта."""
...
async def check_before_delete_project(
    ...
    """Проверяет,, можно ли удалять переданный проект."""
